...
namespace BlogSite.Migrations
{
    ...
    [Migration("20230516162819_tolower")]
    partial class tolower
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogSite.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogSite.Models.Post", b =>
                {
                    ...
                    b.Property<string>("NotAllowedReason")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("BlogSite.Models.Tags", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("BlogSite.Models.Comment", b =>
                {
                    b.HasOne("BlogSite.Models.AppUser", "CommentedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BlogSite.Models.Like", b =>
                {
                    b.HasOne("BlogSite.Models.AppUser", "LikedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BlogSite.Models.Post", b =>
                {
                    ...
                    b.HasOne("BlogSite.Models.Tags", "Tag")
                        .WithMany("Posts")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
